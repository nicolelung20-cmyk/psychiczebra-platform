...
2. **Draft the issue** — Use the template at assets/feedback-issue-template.md to structure the feedback. Fill in the fields based on the conversation. Always identify which specific reference file and section caused the problem.
