# Elevated AI enterprise sales kit

This kit supports ethical outreach for Elevated AI, a product of Elevated Associates LLC. It is designed for executive teams considering a focused AI implementation package, not a guaranteed-revenue or guaranteed-productivity program.

| Document | Use |
|---|---|
| [Offer one-pager](offer-one-pager.md) | Explain the offer, scope, pricing assumptions, and claims boundaries. |
